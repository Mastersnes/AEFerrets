...
public abstract class AbstractServlet<REQ, RESP> extends HttpServlet {
    ...
    protected static Logger LOGGER = new Logger(AbstractServlet.class.getName());
    ...
    protected void doGet(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException,
            IOException {
        httpRequest = req;
        final REQ requete = mapRequest(httpRequest);
     ...
     * @return
     */
    protected String getAttribute(final HttpServletRequest req) {
